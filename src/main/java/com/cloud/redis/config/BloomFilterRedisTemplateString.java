...
public class BloomFilterRedisTemplateString extends RedisTemplate<String, Object> {

    private final BloomFilter<String> bloomFilter;
    private final Random random = new Random();
    private final RedisSerializer<Object> valueSerializer;

    public BloomFilterRedisTemplateString(RedisConnectionFactory connectionFactory, RedisSerializer<Object> valueSerializer) {
    ...
    private class BloomFilterValueOperations implements ValueOperations<String, Object> {
        ...
        public RedisOperations<String, Object> getOperations() {
            return BloomFilterRedisTemplateString.this;
        }
